...
const Index = () => {
  return (
    <div className="terms">
      ...
      <span>Welcome to CRYSTAL GOLD</span>
      <br/>
      <span>These terms and conditions outline the rules and regulations for the use of CRYSTAL GOLD.</span>
      </div>
      <p class="indent-8">
      By using this app we assume you accept these terms and conditions. Do
        not continue to use CRYSTAL GOLD if you do not agree to take all of the
        terms and conditions stated on this page. The following terminology applies to these Terms and Conditions, Privacy
      ...
      <h3>License</h3>
      <p class="indent-8">
        Unless otherwise stated, CRYSTAL GOLD and/or its licensors own the
        intellectual property rights for all material on CRYSTAL GOLD. All
        intellectual property rights are reserved. You may access this from
        CRYSTAL GOLD for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc">
        <li>Republish material from CRYSTAL GOLD</li>
        <li>Sell, rent or sub-license material from CRYSTAL GOLD</li>
        <li>Reproduce, duplicate or copy material from CRYSTAL GOLD</li>
        <li>Redistribute content from CRYSTAL GOLD</li>
      </ul>

      <p class="indent-8">
      This Agreement shall begin on the date hereof. Parts of this app offer an opportunity for users to post and exchange
        opinions and information in certain areas of the website. CRYSTAL GOLD
        ...
        of CRYSTAL GOLD, its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, CRYSTAL GOLD shall not be
        ...
        appearance of the Comments on this website. CRYSTAL GOLD reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant CRYSTAL GOLD a non-exclusive license to use, reproduce,
      ...
      <p class="indent-8">
        ...
        the hyperlink compensates the absence of CRYSTAL GOLD; and (d) the link
      ...
      <p class="indent-8">
        ...
        e-mail to CRYSTAL GOLD. Please include your name, your organization
      ...
      <p>
        No use of CRYSTAL GOLD's logo or other artwork will be allowed for
      ...
      <p class="indent-8">
        ...
        directly. We do not ensure that the information on this website is correct, we do
      ...
      <p class="indent-8">
        ...
        statutory duty. As long as the website and the information and services on the website
